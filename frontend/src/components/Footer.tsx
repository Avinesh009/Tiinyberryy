    ...
    <div className="max-w-[1320px] mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 pb-10 border-b border-white/10">
          ...
          <ul className="space-y-2.5">
            {shopLinks.map((l, i) => (
              <li key={l}>
                <a 
                  href="#" 
                  className="text-[0.82rem] text-gray-400 hover:text-purple-400 transition-all duration-300 hover:translate-x-1 inline-block"
        ...
        <div className="animate-fadeIn" style={{ animationDelay: "0.2s" }}>
          <h4 className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-purple-400 mb-4">Help</h4>
          <ul className="space-y-2.5">
            {helpLinks.map((l, i) => (
              <li key={l}>
                <a 
